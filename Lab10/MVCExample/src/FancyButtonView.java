...
public class FancyButtonView extends JFrame implements Observer {
	...
	public FancyButtonView(Controller controller) {
		...
		duckButton = new JButton(duckLabel, duckIcon);
		duckButton.setVerticalTextPosition(SwingConstants.BOTTOM);
		duckButton.setHorizontalTextPosition(SwingConstants.CENTER);
		duckButton.setActionCommand("INC_DUCKS");
		duckButton.addActionListener(controller);
		this.add(duckButton);
	...
	public void update(Observable o, Object arg) {
		...
		duckButton.setText(Integer.toString(birdCounter.getDucks()));
	}
}
